...
class MountainCarTileCoder:
    ...
    def get_tiles(self, position, velocity):
        ...
        # ----------------
        # your code here
        posscaleFactor = self.num_tiles/(0.5+1.2)
        velscaleFactor = self.num_tiles/(0.07+0.07)
        position_scaled = (position+1.2) * posscaleFactor
        velocity_scaled = (velocity+0.07) * velscaleFactor
        # ----------------
...
class SarsaAgent(BaseAgent):
    ...
    def select_action(self, tiles):
        ...
        # ----------------
        # your code here
        # populate action_values
        

        for a in range(self.num_actions):
            w = self.w[a]
            # !!!array indexing, tile is index
            # https://www.coursera.org/learn/prediction-control-function-approximation/discussions/forums/4Os9QehyEeq93Aq6r8QVHQ/threads/8VyLdwmwEeuvkA4ycPXCUQ
            action_values.append(np.sum(w[tiles]))
    ...
    def agent_step(self, reward, state):
        ...
        #!!! 
        # https://www.coursera.org/learn/prediction-control-function-approximation/discussions/forums/7Pi3I-iiEeqIBw59YHZeOQ/threads/404DxT5iEeuipg7jhk5jrQ
        previous_action_value = np.sum(self.w[self.last_action][self.previous_tiles])        
        delta = reward + self.gamma*action_value - previous_action_value
