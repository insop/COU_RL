...
class Adam():
    ...
    def __init__(self, layer_sizes, 
        ...
        for i in range(0, len(self.layer_sizes) - 1):
            ...
            self.v[i]["W"] = np.zeros_like(self.m[i]["W"])
            self.v[i]["b"] = np.zeros_like(self.m[i]["b"])
...
def optimize_network(experiences, discount, optimizer, network, current_q, tau):
    ...
    ### END CODE HERE
    # your code here
    # update_weights(self, weights, td_errors_times_gradients):
...
class Agent(BaseAgent):
    ...
    def agent_step(self, reward, state):
        ...
        # your code here
        self.replay_buffer.append(self.last_state, action, reward, 0, state)
