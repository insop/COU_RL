...
def run_experiment(environment, agent, environment_parameters, agent_parameters, experiment_parameters):
    ...
    ### END CODE HERE
    # your code here
    n_taus = len(agent_parameters['tau'])
    n_steps = len(agent_parameters['step_size'])
    n_runs = experiment_parameters['num_runs']
    n_episodes = experiment_parameters['num_episodes']
    agent_sum_reward = np.zeros((n_taus, n_steps, n_runs, n_episodes))
